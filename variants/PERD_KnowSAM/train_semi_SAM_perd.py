...
if __name__ == "__main__":
    for fold in range(args.n_fold):
        ...
        if args.snapshot_path:
            ...
            snapshot_path = "./Results/PERD_KnowSAM/fold_" + str(fold)
        ...
        for filename in ["train_semi_SAM_perd.py", "trainer_perd.py", "perd_modules.py"]:
            shutil.copyfile(os.path.join(CURRENT_DIR, filename), os.path.join(code_dir, filename))
        shutil.copyfile(
            os.path.join(CURRENT_DIR, "utils", "losses_perd.py"),
            os.path.join(code_dir, "utils", "losses_perd.py"),
        )
