...
from trainer_perd import Trainer
...
def add_common_args(parser):
    ...
    parser.add_argument("--SGDL_model_path", type=str, default="./Results/PERD_KnowSAM/fold_0/SGDL_best_model.pth")
    parser.add_argument("--sam_model_path", type=str, default="./Results/PERD_KnowSAM/fold_0/sam_best_model.pth")
    parser.add_argument("--save_dir", type=str, default="./Results/PERD_KnowSAM/fold_0/prediction_test")
    parser.add_argument("--num_workers", type=int, default=0)

    parser.add_argument("--perd_enabled", type=int, default=1)
    parser.add_argument("--perd_delta_pixels", type=int, default=2)
    parser.add_argument("--perd_delta_levels", type=str, default="-4,-2,0,2,4")
    parser.add_argument("--perd_tube_radius", type=int, default=5)
    parser.add_argument("--perd_atten_kernel", type=int, default=9)
    parser.add_argument("--perd_atten_strength", type=float, default=0.25)
    parser.add_argument("--perd_beta_ed", type=float, default=6.0)
    parser.add_argument("--perd_beta_pc", type=float, default=2.0)
    parser.add_argument("--perd_beta_j", type=float, default=1.0)
    parser.add_argument("--perd_ed_mid", type=float, default=0.05)
    parser.add_argument("--perd_min_area_change", type=float, default=0.005)
    parser.add_argument("--perd_max_area_change", type=float, default=0.40)
    parser.add_argument("--perd_saturation_iou", type=float, default=0.995)
    parser.add_argument("--perd_log_interval", type=int, default=20)
    parser.add_argument("--perd_prompt_logit", type=float, default=6.0)
    parser.add_argument("--perd_disable_ed", type=int, default=0)
    parser.add_argument("--perd_disable_pc", type=int, default=0)
    parser.add_argument("--perd_no_attenuation", type=int, default=0)
    parser.add_argument("--perd_baseline", type=str, default="perd", choices=["perd", "prompt_ensemble"])
    parser.add_argument("--perd_attenuation_mode", type=str, default="boundary", choices=["boundary", "random", "interior", "none"])
...
def forward_perd(trainer, image):
...
def main():
    ...
    with torch.no_grad():
        for index, sampled_batch in enumerate(test_loader):
            ...
            fusion_soft, sam_soft = forward_perd(trainer, test_image)
