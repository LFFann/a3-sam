...
def parse_args():
    ...
    parser.add_argument("-UNet_lr", type=float, default=0.003)
    ...
    parser.add_argument("--mixed_iterations", type=int, default=1000, help="compatibility placeholder")
    ...
    parser.add_argument("--consistency_rampup", type=float, default=500.0)
...
if __name__ == "__main__":
    for fold in range(args.n_fold):
        ...
        if args.snapshot_path:
            ...
            snapshot_path = "./Results/A3_PASS_KnowSAM_Multiclass_260514/fold_" + str(fold)
