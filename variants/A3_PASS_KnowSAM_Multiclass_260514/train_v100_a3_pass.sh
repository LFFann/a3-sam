...
SNAPSHOT_PATH="${SNAPSHOT_PATH:-./Results/A3_PASS_KnowSAM_Multiclass_V100_bs32_10k_106_117_13_13_260514}"
...
echo "Starting A3-PASS-KnowSAM multiclass 260514 V100 training with:"
...
"${PYTHON_BIN}" ./variants/A3_PASS_KnowSAM_Multiclass_260514/train_semi_SAM_a3_pass.py \
  --data_path "${DATA_PATH}" \
  --dataset "${DATASET}" \
  --num_classes 3 \
